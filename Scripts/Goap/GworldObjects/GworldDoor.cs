...
[CreateAssetMenu(fileName = "GWorldObjects", menuName = "WorldObjectDoor")]
public class GworldDoor : GworldObject
{
    GDoorController DoorController;

    public override void InitOwnerObj()
    {

        DoorController = OwnerObj.gameObject.GetComponent<GDoorController>();
        DoorController.currentDoor = this;
        Debug.Log("Door Controller" + DoorController);
    }
